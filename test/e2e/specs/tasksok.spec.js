const TasksPage = require('../pageObjects/tasksok.page')
...
describe('Tasks tests', () => {
  ...
  it('can_delete_a_task', () => {
    ...
    // Els alumnes si que l'han de fer
  ...
  it('can_edit_a_task', () => {
    ...
    // TODO Els alumnes si que l'han de fer
  ...
  it('can_filter_tasks_by_completed_and_pending_and_all', () => {
    ...
    expect(TasksPage.list).toHaveTextContaining(sampleItems[0])
    expect(TasksPage.list).toHaveTextContaining(sampleItems[1])
    expect(TasksPage.list).toHaveTextContaining(sampleItems[2])
    expect(TasksPage.listSize).toEqual(3)

    TasksPage.filterByCompleted()
    expect(TasksPage.listSize).toEqual(1)
    expect(TasksPage.list).not.toHaveTextContaining(sampleItems[0])
    expect(TasksPage.list).not.toHaveTextContaining(sampleItems[1])
    expect(TasksPage.list).toHaveTextContaining(sampleItems[2])
    ...
    expect(TasksPage.list).toHaveTextContaining(sampleItems[0])
    expect(TasksPage.list).toHaveTextContaining(sampleItems[1])
    expect(TasksPage.list).not.toHaveTextContaining(sampleItems[2])
